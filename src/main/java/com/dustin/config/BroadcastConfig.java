...
public class BroadcastConfig {
    ...
    public final static String FANOUT_QUEUE_1_NAME = "com.dustin.spring-amqp-simple.fanout.queue1";
    public final static String FANOUT_QUEUE_2_NAME = "com.dustin.spring-amqp-simple.fanout.queue2";
    public final static String FANOUT_EXCHANGE_NAME = "com.dustin.spring-amqp-simple.fanout.exchange";

    public final static String TOPIC_QUEUE_1_NAME = "com.dustin.spring-amqp-simple.topic.queue1";
    public final static String TOPIC_QUEUE_2_NAME = "com.dustin.spring-amqp-simple.topic.queue2";
    public final static String TOPIC_EXCHANGE_NAME = "com.dustin.spring-amqp-simple.topic.exchange";
